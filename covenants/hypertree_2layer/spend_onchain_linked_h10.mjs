...
const COV_TXID = 'f8fc66bb53e80806a8ed1928d4b54b147b22b9e71be694207b2f19d2ec303f9e';
const COV_IDX = 0;
const COV_AMT = 15000000n;
const COV_SPK_HEX = 'aa206daa2a4521732280c4b62f5cae0013e0de1d908a8b98b34ebc4e621b3978532487';
const REDEEM_SCRIPT_HEX = fs.readFileSync('./onchain_linked_2layer_h10_script.hex', 'utf8').trim();
const WITNESS = JSON.parse(fs.readFileSync('./onchain_linked_2layer_h10_witness.json', 'utf8'));
