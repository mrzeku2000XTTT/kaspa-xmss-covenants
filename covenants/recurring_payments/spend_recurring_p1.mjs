...
const COV_TXID = 'eff1db93c2b9b61d6f7a8208b794d10474b75b524367b3cbc0d26a0a61008f66';
const COV_IDX = 0;
const COV_AMT = 15000000n;
const COV_SPK_HEX = 'aa204f14ec984b7d4ef8a52cffa3d9f71fdee08783021c6f746fa6720575effc745687';
const REDEEM_SCRIPT_HEX = fs.readFileSync('./recurring_p1_script.hex', 'utf8').trim();
const WITNESS = JSON.parse(fs.readFileSync('./recurring_p1_witness.json', 'utf8'));
