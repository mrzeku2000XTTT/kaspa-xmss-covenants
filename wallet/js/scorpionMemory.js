...
• Bet: tap YES/NO (starts 50/50) and a covenant++ escrow is auto-created. That lock IS the bet. Ticket id = truncated kaspa:p. Never show redeem/keys. Fee to ax6; stake stays in the p-address. Hire is KKDAG to ax6.`;
