...
const COV_TXID = 'e5198d91c7b14773f1e68e8579e96f442f62a18fb6ddcf02eaba4377629c5f50';
const COV_IDX = 0;
const COV_AMT = 15000000n;
const COV_SPK_HEX = 'aa206072f79d971835856e27c98474f67c2a3dcdaef92c553efe28881e983574f92987';
const REDEEM_SCRIPT_HEX = fs.readFileSync('./xmss_generic_deploy_script.hex', 'utf8').trim();
const WITNESS = JSON.parse(fs.readFileSync('./xmss_generic_witness.json', 'utf8'));
