...
const COV_TXID = '2b5e04463cef8735c167edcc91e7a8835b35f5eb998f3d8436588078860eaed4';
const COV_IDX = 0;
const COV_AMT = 15000000n;
const COV_SPK_HEX = 'aa20c229efad3d4d90a01490d46386b37a17ed391974924380576a00b3c36da1b64387';
const REDEEM_SCRIPT_HEX = fs.readFileSync('./onchain_linked_2layer_h16_script.hex', 'utf8').trim();
const WITNESS = JSON.parse(fs.readFileSync('./onchain_linked_2layer_h16_witness.json', 'utf8'));
