...
const COV_TXID = 'ffbbdc0c99f6d038af41d583a713f62c1a1ecf8cacc94695f645bf2d8f8e7cfa';
const COV_IDX = 0;
const COV_AMT = 15000000n;
const COV_SPK_HEX = 'aa20a32902892a56e8ba39a9b01ff09a6cdf3f0952e2cc0209dfbdc0956829c7341287';
const REDEEM_SCRIPT_HEX = fs.readFileSync('./recurring_p2_script.hex', 'utf8').trim();
const WITNESS = JSON.parse(fs.readFileSync('./recurring_p2_witness.json', 'utf8'));
