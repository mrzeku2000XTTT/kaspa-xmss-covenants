...
const COV_TXID = '2a53d72191d0fe50c17e7c534a7986eb74623034fcd5b63524b60b33c525ea09';
const COV_IDX = 0;
const COV_AMT = 15000000n;
const COV_SPK_HEX = 'aa209e531ffff093e281eb2284124518bc755aa5ff93167a505c0d43d7f81454b34387';
const REDEEM_SCRIPT_HEX = fs.readFileSync('./onchain_linked_2layer_script_v2.hex', 'utf8').trim();
const WITNESS = JSON.parse(fs.readFileSync('./onchain_linked_2layer_witness_v2.json', 'utf8'));
